...
![Reinforcement Learning Control-Loop]({{ '/assets/imgs/reinforcement_learning/reinforcement_learning_loop.png' | relative_url}}){: style="width: 70%; margin: 0 auto; display: block;"}
<p align="center"> **Figure 1.** Reinforcement Learning Control-Loop [1]</p>
...
![Reinforcement Learning Algorithms Taxonomy]({{ '/assets/imgs/reinforcement_learning/rl_algorithms_taxonomy.svg' | relative_url}}){: style="width: 90%; margin: 0 auto; display: block;"}
<p align="center"> **Figure 2.** Non-exhaustive RL algorithms taxonomy [2] </p>
...
![pseudocode REINFORCE algorithm with baseline]({{ '/assets/imgs/reinforcement_learning/reinforce.png' | relative_url}}){: style="width: 80%; margin: 0 auto; display: block;"}
<p align="center"> **Figure 3.** Pseudocode REINFORCE with baseline [1]</p>

<p align="justify">
One problem of REINFORCE is the policy gradient estimate can have high variance. One way to reduce this is by introducing a baseline (see Figure 3). Next we are going to learn about two popular value-based algorithms, SARSA and Q-Networks. If you are interested in how the actual code would look like, check out my [RL repository](https://github.com/johanngerberding/reinforcement-learning-pytorch).
</p>
...
2. Generate target Q-values $Q_{tar}$ based on the trajectories.
3. Minimize the distance between $\hat{Q}$ and $Q_{tar}$ using a standard regression loss (like MSE)
4. Repeat 1-3
...
![pseudocode SARSA algorithm]({{ '/assets/imgs/reinforcement_learning/sarsa.png' | relative_url}}){: style="width: 80%; margin: 0 auto; display: block;"}
<p align="center"> **Figure 4.** Pseudocode SARSA from [1] </p>
...
![Deep Q-Learning Algorithm with Experience Replay]({{ '/assets/imgs/reinforcement_learning/deep_q_learning_with_experience.png' | relative_url}}){: style="width: 90%; margin: 0 auto; display: block;"}
<p align="center"> **Figure 5.** Deep Q-Learning Algorithm with Experience Replay [3] </p>
...
<p align="justify">
In this post I have tried to give a very short intro to the basic terminology of Reinforcement Learning. If you are interested in this field I encourage you to take a look a Barto and Suttons [Reinforcement Learning: An Introduction](http://incompleteideas.net/book/the-book.html) and the great resource [OpenAI Spinning Up](https://spinningup.openai.com/en/latest/index.html) created by Josh Achiam.
</p>
